...
<nav class="{% block nav_classes %}navbar navbar-expand-lg navbar-light{% endblock %}" style="background-image: linear-gradient(to right, #ed6ea0, #ec8c69, #f7186a , #FBB03B); box-shadow: 0 4px 15px 0 rgba(236, 116, 149, 0.75); border-radius: 15px;">
