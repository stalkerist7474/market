...
{% load static %}
<!DOCTYPE html>
<html lang='{{ LANGUAGE_CODE|default:"ru" }}' class="{% block html_class %}no-js{% endblock %}">
    <head>

        <link rel="stylesheet" href='{% static "oscar/css/customCSS/myStyle.css" %}'>
        ...
        {% block favicon %}
            <link rel="shortcut icon" href='{% static "oscar/faviconCat.png" %}' />
        {% endblock %}
